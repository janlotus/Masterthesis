...
from system.bio_model.HeadDirectionCellModel.params import n_hdc,lam_hdc
from scipy.ndimage.interpolation import shift
from system.bio_model.HeadDirectionCellModel.neuron import phi, phi_inv, phi_vec
from scipy.optimize import minimize
from scipy.fftpack import fft, ifft
import pickle
import math
from system.bio_model.HeadDirectionCellModel.hdcTargetPeak import targetPeakHD, targetPeakCONJ
from system.bio_model.HeadDirectionCellModel.helper import angleDistAbs,writeDataToFile
from system.bio_model.HeadDirectionCellModel.hdcOptimizeAttractor import getHDCActivity
...
def CalcAndPlotWeights():
    ...
    writeDataToFile(wECDtoCONJ, 'system/bio_model/HeadDirectionCellModel/data/model/weights/w_ecd_to_conj.obj')
    writeDataToFile(wECDtoCONJ, 'system/bio_model/HeadDirectionCellModel/data/model/weights/w_acd_to_conj.obj')
    # writeDataToFile(wECDtoCONJ, 'datatest/model/weights/w_ecd_to_conj.obj')
    # writeDataToFile(wECDtoCONJ, 'datatest/model/weights/w_acd_to_conj.obj')
    ...
    writeDataToFile(wCONJtoACD, 'system/bio_model/HeadDirectionCellModel/data/model/weights/w_conj_to_acd.obj')
    # writeDataToFile(wCONJtoACD, 'datatest/model/weights/w_conj_to_acd.obj')
    ...
    writeDataToFile(wCONJtoHD, 'system/bio_model/HeadDirectionCellModel/data/model/weights/w_conj_to_hd.obj')
    # writeDataToFile(wCONJtoHD, 'datatest/model/weights/w_conj_to_hd.obj')
    ...
    writeDataToFile(wHDtoCONJ, 'system/bio_model/HeadDirectionCellModel/data/model/weights/w_hd_to_conj.obj')
    # writeDataToFile(wHDtoCONJ, 'datatest/model/weights/w_hd_to_conj.obj')

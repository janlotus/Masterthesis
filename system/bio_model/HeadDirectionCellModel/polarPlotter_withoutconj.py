...
from system.bio_model.HeadDirectionCellModel.neuron import r_m
...
class PolarPlotter:
    def __init__(self, n, bias, invert,PosCueDirEncoder):
        ...
        # ax3 = plt.subplot(332) # for CCF1
        ax4 = plt.subplot(313, projection="polar")
        # ax5 = plt.subplot(337) # for CCF2
        # #ax6 = plt.subplot(339, projection="polar")
        # ax7 = plt.subplot(338) # for vector array
        #
        # ax7_2 = ax7.twinx()
        # ax7_3 = ax7.twiny()
    ...
    def plot(self, rates_hdc, rates_sl, rates_sr, rates_ecd, rates_acd,
             stimL, stimR, trueOrientation, decOrientation): #rates_hdc2,
        n = self.n
        if self.showStims:
    ...
    #
    #
    # def plot_withoutConj(self, rates_hdc, rates_sl, rates_sr, rates_ecd,  rates_acd,

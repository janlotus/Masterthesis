...
from system.bio_model.HeadDirectionCellModel.hdcTargetPeak import targetPeakHD
from system.bio_model.HeadDirectionCellModel.params import n_hdc, weight_av_stim
import pickle
from system.bio_model.HeadDirectionCellModel.neuron import phi, phi_inv, tau
from system.bio_model.HeadDirectionCellModel.helper import loadDataFromFile
...
class HDCAttractorConnectivity:
    ...
    def InitCalibrLoopWeights(self):
        try:
            self.w_ecd_to_conj = loadDataFromFile('system/bio_model/HeadDirectionCellModel/data/model/weights/w_ecd_to_conj.obj')
            self.w_acd_to_conj= loadDataFromFile('system/bio_model/HeadDirectionCellModel/data/model/weights/w_acd_to_conj.obj')
            self.w_hd_to_conj= loadDataFromFile('system/bio_model/HeadDirectionCellModel/data/model/weights/w_hd_to_conj.obj')
            self.w_conj_to_acd= loadDataFromFile('system/bio_model/HeadDirectionCellModel/data/model/weights/w_conj_to_acd.obj')
            self.w_conj_to_hd= loadDataFromFile('system/bio_model/HeadDirectionCellModel/data/model/weights/w_conj_to_hd.obj')
        except Exception:

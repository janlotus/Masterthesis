...
class GridCellNetwork:
    ...
    def initialize_network(self, nr_steps, filename):
        ...
        plot_grid_cell_modules(self.gc_modules, nr_steps) # this 2 plot will result in simulation problem
    ...
    def consolidate_gc_spiking(self, virtual=False):
        ...
        s_vectors = np.zeros((len(self.gc_modules), len(self.gc_modules[0].s))) # 6 *1600
